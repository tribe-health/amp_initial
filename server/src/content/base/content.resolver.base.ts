...
import { ContentType } from "../../contentType/base/ContentType";
...
export class ContentResolverBase {
  ...
  @graphql.ResolveField(() => ContentType, { nullable: true })
  @nestAccessControl.UseRoles({
    resource: "Content",
    action: "read",
    possession: "any",
  ...
  async contentType(
    ...
    const result = await this.service.getContentType(parent.id);
